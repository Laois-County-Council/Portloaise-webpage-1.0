...
import { ConversationScenarios } from "@/components/conversation-scenarios"
import { 
  BookOpen, 
  Globe, 
  Smartphone, 
      ...
      <Card className="mb-8 border-green-500/30 bg-green-50/50 dark:bg-green-950/20">
        ...
        <CardContent>
          ...
          >
            ...
            {t("learn.scenarios.browse")}
          </Button>
        </CardContent>
      </Card>

      {/* Scenarios Dialog */}
      <ConversationScenarios open={scenariosOpen} onClose={() => setScenariosOpen(false)} />
